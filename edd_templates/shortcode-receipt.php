...
<?php if ( $edd_receipt_args[ 'products' ] ) : ?>
	...
	<table id="edd_purchase_receipt_products" class="table table-striped table-hover table-bordered">
		<thead>
							...
							if ( ! empty( $download_files ) && is_array( $download_files ) ) :
								...
								foreach ( $download_files as $filekey => $file ) :
									...
									<li class="edd_download_file">
										<a class="btn btn-success" href="<?php echo esc_url( $download_url ); ?>" class="edd_download_file_link"><span class="fa fa-download"></span> <?php echo edd_get_file_name( $file ); ?></a>
									</li>
									<?php
